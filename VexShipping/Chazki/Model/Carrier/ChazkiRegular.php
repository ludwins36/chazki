...
class ChazkiRegular extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    
    protected $_code = 'chazkiregular';
    protected $ciudades;
    ...
    {
        return [$this->_code => $this->getConfigData('nameregular')];
    }
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if( $code != '' ){
            ...
            $method->setMethodTitle('Chazki Regular');

            $descripcion = 'Aseguramos el recojo y la entrega el mismo día. De 9:00am a 9:00pm';

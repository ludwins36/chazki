...
class ChazkiProgramado extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    
    protected $_code = 'chazkiprogramado';
    protected $ciudades;
    ...
    {
        return [$this->_code => $this->getConfigData('nameprogramado')];
    }
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if( $code != '' ){
            ...
            $method->setMethodTitle('Chazki Programado');

            $descripcion = 'Programa envíos en rangos horarios. Recojo en mañana, tarde o noche. Seleccionar en el formulario el horario';
            ...
            if($distancia<=5){
                ...
                $distanciaaux = 1.13*ceil($distancia-30);
                $amount = 18+$distanciaaux;
            }
